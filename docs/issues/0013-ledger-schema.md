...
## Goal
Create ledger_accounts, ledger_entries tables (double-entry)
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(ledger): create ledger_accounts, ledger_entries tables (double-entry) - Refs #0013`
