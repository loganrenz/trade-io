...
## Goal
Implement account write APIs (create, manage members)
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(account): implement account write apis (create, manage members) - Refs #0021`
