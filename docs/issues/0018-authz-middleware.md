...
## Goal
Create authorization middleware with RLS/query filters
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(authz): create authorization middleware with rls/query filters - Refs #0018`
