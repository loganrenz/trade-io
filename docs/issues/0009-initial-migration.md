...
## Goal
Create users, accounts, account_members tables migration
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(initial): create users, accounts, account_members tables migration - Refs #0009`
