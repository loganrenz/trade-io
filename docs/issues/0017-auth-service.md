...
Implement authentication service (login, signup, sessions)
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(auth): implement authentication service (login, signup, sessions) - Refs #0017`
