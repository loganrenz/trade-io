...
Create portfolio summary API (account value, holdings)
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(portfolio): create portfolio summary api (account value, holdings) - Refs #0053`
