...
## Goal
Create instruments, quotes, bars, trading_sessions tables
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(market): create instruments, quotes, bars, trading_sessions tables - Refs #0011`
