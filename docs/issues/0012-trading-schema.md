...
## Goal
Create orders, order_events, executions, positions tables
...
- [ ] Linters passing
- [ ] Security verified
- [ ] Commit: `feat(trading): create orders, order_events, executions, positions tables - Refs #0012`
